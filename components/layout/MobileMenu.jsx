      ...
      <div className="container mx-auto flex justify-end">
        <div className="w-full md:w-6/12">
          <div className="menu-box w-full px-8 md:px-10 py-10 md:py-12 shadow-2xl">
            <div className="flex justify-end duration-500">
              <button onClick={() => props.closeMenu()}>
                <div className="w-12 h-[0.187rem] rounded bg-black menu-x-top"></div>
            ...
            <nav className="text-right text-4xl font-montserrat pt-8">
              ...
              <div className="flex justify-between text-xs font-normal text-gray-400 pt-12">
